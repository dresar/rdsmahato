  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md">
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-muted-foreground mt-1">Masuk ke akun Pesantren Hub Anda</p>
      </div>
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <div>
            ...
            <div className="relative">
              <input type={showPassword ? 'text' : 'password'} className="w-full px-4 py-2.5 pr-10 text-sm rounded-lg bg-secondary border border-border focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary" placeholder="••••••••" />
